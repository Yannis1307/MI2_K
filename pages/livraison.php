...
<body>
    ...
    <header class="mobile-header">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="accueil.php" class="btn-header-action"
                style="width: auto; padding: 0 14px; color: #6498ff; border-color: rgba(100, 160, 255, 0.3); background: rgba(100, 160, 255, 0.08); font-size: 0.75rem; font-weight: bold; text-transform: uppercase;">🏠
                Vue Client</a>
            <a href="deconnexion.php" class="btn-header-action"
                style="width: auto; padding: 0 14px; color: #ff4444; border-color: rgba(255, 68, 68, 0.3); background: rgba(255, 68, 68, 0.08); font-size: 0.75rem; font-weight: bold; text-transform: uppercase;">🚪
                Déconnexion</a>
        </div>
    </header>
        ...
        <div class="mobile-container">
            ...
            <section class="mission-card">
                    ...
                    <div class="mission-section access-section">
                        ...
                        <div class="access-grid">
                            <div class="access-bubble">
                                ...
                                <span
                                    class="access-value"><?php echo isset($mission['code_interphone']) && $mission['code_interphone'] !== '' ? htmlspecialchars($mission['code_interphone']) : 'Non renseigné'; ?></span>
                            </div>
                            <div class="access-bubble">
                                <span class="access-icon">🏢</span>
                                <span class="access-label">Étage</span>
                                <span
                                    class="access-value"><?php echo isset($mission['etage']) && $mission['etage'] !== '' ? htmlspecialchars($mission['etage']) : 'Non renseigné'; ?></span>
                            </div>
                            <div class="access-bubble access-phone">
                                <span class="access-icon">📞</span>
                                <span class="access-label">Téléphone</span>
                                <span
                                    class="access-value"><?= htmlspecialchars(!empty($mission['telephone_client']) ? $mission['telephone_client'] : '—') ?></span>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php foreach ($mission['menus'] as $m): ?>
                                    <li>
                                        ...
                                        <?php if (isset($m['plats_details']) && !empty($m['plats_details'])): ?>
                                            <ul
                                                style="list-style: none; padding-left: 20px; font-size: 0.85em; opacity: 0.8; margin-top: 4px;">
                ...
                <?php else: ?>
                    ...
                    <div class="mission-section" style="text-align: center; padding: 60px 20px;">
                        <p style="font-size: 1.3em; color: rgba(255,255,255,0.5); margin-bottom: 10px;">📡 Aucune mission en
                            cours</p>
                        <p style="color: rgba(255,255,255,0.3); font-size: 0.9em;">En attente d'une nouvelle livraison...
                        </p>
                    </div>
                <?php endif; ?>
            ...
            <?php if ($mission): ?>
                <div class="confirm-zone" style="display: flex; flex-direction: column; gap: 10px;">
                    <div style="width: 100%;">
                        <button type="button" data-cmd="<?= htmlspecialchars($mission['id']) ?>" data-action="livrer"
                            class="btn-confirm-delivery js-action-livraison" style="width: 100%; margin-bottom: 10px;">✅
                            CONFIRMER LA LIVRAISON</button>
                        <button type="button" data-cmd="<?= htmlspecialchars($mission['id']) ?>" data-action="abandonner"
                            class="btn-help js-action-livraison"
                            style="width: 100%; background: rgba(255, 50, 50, 0.1); border: 1px solid #ff4444; color: #ff4444;">❌
                            SIGNALER COMME ABANDONNÉE</button>
                    </div>
                </div>
            <?php endif; ?>
